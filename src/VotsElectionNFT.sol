...
contract VotsElectionNft is IVotsElectionNft, ERC721, ERC721URIStorage, Ownable {
    ...
    function mintElectionNft(
        ...
        emit ElectionNftMinted(nftTokenId, electionTokenId, creator, electionName);
    ...
    function _generateSVG(IVotsElectionNft.ElectionNftData memory nftData) internal pure returns (string memory) {
        return string(
            abi.encodePacked(
                ...
                '<text x="50" y="140" font-family="Arial, sans-serif" font-size="16" font-weight="bold" fill="white">Election:</text>',
                '<text x="50" y="165" font-family="Arial, sans-serif" font-size="14" fill="white">',
                _truncateString(nftData.electionName, 25),
                "</text>",
                '<text x="50" y="200" font-family="Arial, sans-serif" font-size="16" font-weight="bold" fill="white">Type:</text>',
                '<text x="50" y="225" font-family="Arial, sans-serif" font-size="14" fill="white">',
                nftData.electionDescription,
                "</text>",
                '<text x="50" y="260" font-family="Arial, sans-serif" font-size="16" font-weight="bold" fill="white">Token ID:</text>',
                '<text x="50" y="285" font-family="Arial, sans-serif" font-size="14" fill="white">#',
                nftData.electionTokenId.toString(),
                "</text>",
                '<text x="50" y="320" font-family="Arial, sans-serif" font-size="16" font-weight="bold" fill="white">Creator:</text>',
                '<text x="50" y="345" font-family="Arial, sans-serif" font-size="12" fill="white">',
