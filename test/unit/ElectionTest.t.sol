...
//     function testCompareStringsSuccess() public pure {
//         assertTrue(StringUtils.compareStrings("hello", "hello"));
//         assertFalse(StringUtils.compareStrings("hello", "world"));
//         assertTrue(StringUtils.compareStrings("", ""));
//         assertFalse(StringUtils.compareStrings("test", ""));
//     }
