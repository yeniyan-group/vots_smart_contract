...
contract VotsEngineTest is Test {
    ...
    IElection.VoterInfoDTO voterOne =
        IElection.VoterInfoDTO({name: "Voter1", matricNo: "VOT001", department: "Computer Science", level: 100});
    ...
    function testVoteCandidatesSuccess() public {
        ...
        votsEngine.addVotersToElection(votsEngine.getElectionTokenId(ELECTION_NAME), votersList);
        vm.stopPrank();
        // startTimestamp,
        // endTimestamp,
        // ELECTION_NAME,
    ...
    function testGetElectionResultsAfterElectionEnds() public {
        ...
        // Get results
        Election.CandidateInfoDTO[] memory allCandidates = votsEngine.getAllCandidates(tokenId);
